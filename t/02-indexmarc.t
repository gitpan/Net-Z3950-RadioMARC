# $Id: 02-indexmarc.t,v 1.1 2004/11/29 13:39:39 mike Exp $
...
#	unlink($tmpfile);
	SKIP: {
	    ...
	    ok($stat[7] == 100930, "checked index size");
	}
    }
    ...
    ok(istr($hithash->{20}) eq "710a:4", "record 20 indexing is as expected");
    ok(istr($hithash->{21}) eq "710a:4", "record 21 indexing is as expected");
